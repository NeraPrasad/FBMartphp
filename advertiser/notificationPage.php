...
<html lang="en">
  <head>
	<title>Notification Page - Advertiser</title>
                    ...
                    <div class="career-search mb-60">
                        <div class="filter-result">
                            <form method="post" action="notificationPage.php">
                                ...
                                $userId = $_SESSION['id'];
                                $sql = "SELECT * FROM fb_request WHERE userId = '$userId' AND order_status=1 AND notify_advertiser = 0";
                    ...
                    <div class="career-search mb-60">
                        <div class="filter-result">
                            <form method="post" action="notificationPage.php">
                                ...
                                require '../component/database.php';
                                $userId = $_SESSION['id'];
                                $sql = "SELECT * FROM fb_request WHERE userId = '$userId' AND order_status=1 AND notify_advertiser = 1";
                                $result = $conn->query($sql);
