...
if(isset($_GET["id"]))
{
	  ...
	  $orderstatus = mysqli_query($conn,"UPDATE fb_request SET order_status=1 where id='$id'");
...
elseif (isset($_GET["orderReject"])) {
	...
	$orderstatus = mysqli_query($conn,"UPDATE fb_request SET order_status=0 where id='$orderReject'");
